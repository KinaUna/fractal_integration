...
> **The gist:** the parts are cheap; effective linkage is rare, but it's
> what makes a system work at all. Integration — linking differentiated
> parts, seems to matter at every scale, from a single function
> to a life to a whole ecosystem.

## Why I think this is worth an hour

This isn't a new idea, as far as I can tell. Systems theory, cybernetics,
the study of institutions, even the leading theories of consciousness seem
to converge on roughly the same claim: differentiated parts, linked well,
produce something no part has alone, and most failure is a failure of the
linkage, not the parts. I don't think these guidelines add a new truth.
What I was after was a shared, practical vocabulary for a pattern I already
try to find ways to integrate in my own life. Something kept in one place, kept alive,
and easy to bring into whatever I'm building.

Once I started looking more closely for it, I saw it at every size:
...
- **The smallest scale.** A relay team drops the baton, four excellent
  ...
  moment.
- **My work.** Tests are green, the deploy ships, and production still
  breaks. The parts were fine, but the seam between them was never tested.
- **My life.** Burnout isn't one broken part, such as not enough sleep, too
  ...
  person looks like the same one to me: the parts are fine, the linkage is
  failing.
- **The biggest scale I can think of.** The 2008 financial crisis was
  mortgage risk deliberately sliced and resold to sever the link between
  who originated a loan and who bore its consequence, a bilateral-
  integration failure with a trillion-dollar price tag. Climate change
  looks like a planet-sized feedback loop with no owner: the cost of
  carbon is differentiated from whoever emits it, so nothing corrects.
  Political polarization and the erosion of institutional trust read to
  me as a narrative and interpersonal integration failure at the scale of
  a whole society — different groups with no shared story and no
  functioning feedback between them.

I don't think of these as "like" an integration failure, as a figure of
speech. I think they *are* one, the same failure your team has, inflated to
mega-corporate scales. That's the actual concept behind "fractal": not that the world
is mystically made of fractals, but that this one failure mode, parts
without adequate linkage, seems to repeat, recognizably, at every scale
I've looked. Learning to see it in a traffic jam, where every driver fine on
their own, the coordination between them breaking down, makes it easier
to see in a headline, at least for me, the reverse also seems true.

**Use this like a travel guide, not a lexicon.** These pages aren't a
canon to memorize or a tutorial with a right answer at the end. I mean them
as a way of noticing something that's already there, so you can name it and
act on it in whatever terrain you're actually in, a PR, a diagnosis, a
...
document I'd print once: I want the guidelines to keep fractally
integrating, with your domain, your team's language, and other ideas you
find, rather than staying fixed. See
...
That's more or less the entire philosophy. It applies to any differentiated
system: a process, a product, an organization, a team, a person. The rest
of this folder is the same idea applied at each scale.

Because the same pattern seems to repeat everywhere, I call the whole
philosophy **Fractal Integration**, and this folder, the docs and the
templates that try to operationalize it — the **Fractal Integration
Guidelines (FIG)**.

The core docs in this folder are domain-neutral. Code and product are the
first two applications I've actually started writing up; guides for other
professions, like HR, accounting, and so on, can be added on the same pattern
(see [Applying it to your domain](#applying-it-to-your-domain)).

## The same idea, in everyday life

Before the idea scales up, here it is in things you can touch:
...
matched to your own background rather than mine? See
...
Read that table once and you've basically read the whole repo. Every doc
below is one row, expanded.

## The six things I hold (short version)
...
- **Closed-loop:** can someone take a problem in and get an outcome out,
  ...
  system, is a seam I didn't integrate.
...
I try to run these in every review and retro — and whenever a decision
...
**C**oherent, **E**nergizing, **S**table. I borrow the same shape to ask
the same question of a system, a team, or a product:
...
FACES score, so a cycle can move one of the five faces on purpose, and a
...
The order is deliberate: idea → what the product is for → how I build →
how I run it → the life it all lives in → the lenses that connect it all →
...
> I don't want to trade the whole, whether the whole is a system, a team,
> or a person — for a part's output.

I try to revisit this page with the rest of the guidelines, every so
often. Disagree with something here? That's principle 4 — the loop wants
your signal.